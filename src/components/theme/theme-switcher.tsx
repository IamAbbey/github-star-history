...
const [activeTheme, setActiveTheme] = useThemeConfigStore((state) => [state.activeTheme, state.setActiveTheme]);
  ...
  if (!mounted) {
    return (
      <div
        className={cn(
          "flex items-center justify-center gap-0.5 lg:justify-start lg:gap-1",
          className
        )}
      >
        {themes.map((theme) => (
